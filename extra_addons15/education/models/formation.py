...
class Registration(models.Model):
    ...
    def action_done(self):
        if self.student_id:
            ...
            raise UserError(_('Veuillez spécifier un étudiant.'))
        return True
    ...
    def write(self, vals):
        if not self.student_id:
            ...
            vals['name'] = self.code + self.student_id.name
    ...
    student_id = fields.Many2one('res.partner', string='Etudiant', domain="[('student_ok', '=',False)]",
                                 track_visibility='onchange')
    state = fields.Selection([('new', 'Nouveau'), ('done', 'Validé'), ('paid', 'Payé'), ('cancel', 'Annulé')],
    ...
    def action_gererate_order(self):
        if self.student_id and self.service_id and self.order_ok == False:
            ...
            raise exceptions.except_orm(u'Attention !!', u'Veuillez choisir un étudiant !')
        return True
